...
namespace OgrenciTakipYazilim.Bll.Generals
{
    ...
    {
        public IEnumerable<BaseHaraketEntity> List(Expression<Func<IletisimBilgileri, bool>> filter)
        {
            return List(filter, x => new IletisimBilgileriL()
            {
                ...
                EvTelefon = x.Iletisim.EvTelefon,
                IsTelefon1 = x.Iletisim.IsTelefon1,
                IsTelefon2 = x.Iletisim.IsTelefon2,
                CepTelefon1 = x.Iletisim.CepTelefon1,
                CepTelefon2 = x.Iletisim.CepTelefon2,
