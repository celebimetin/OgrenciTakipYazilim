...
namespace OgrenciTakipYazilim.UI.Win.UserControls.Grids
{
    ...
    public class MyBandedGridControl : GridControl
    {
        ...
        {
            MyBandedGridView view = (MyBandedGridView)CreateView("MyBandedGridView");
            ...
            BandedGridColumn idColumn = new BandedGridColumn
            {
                Caption = "Id",
                FieldName = "Id"
            };
            ...
            BandedGridColumn kodColumn = new BandedGridColumn
            {
                Caption = "Kod",
                FieldName = "Kod"
            };
    ...
    public class MyBandedGridView : BandedGridView, IStatusBarKisaYol
    {
        ...
        private class MyGridColumnCollection : BandedGridColumnCollection
        {
            ...
            {
                MyBandedGridColumn column = new MyBandedGridColumn();
