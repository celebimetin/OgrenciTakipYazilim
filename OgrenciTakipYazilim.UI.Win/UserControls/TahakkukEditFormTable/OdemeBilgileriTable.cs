...
namespace OgrenciTakipYazilim.UI.Win.UserControls.TahakkukEditFormTable
{
    public partial class OdemeBilgileriTable : BaseTablo
    {
        ...
        {
            InitializeComponent();
            BllTablo = new OdemeBilgileriBll();
            Tablo = tablo;
            EventsLoad();
        ...
        protected override void Listele()
        {
            tablo.GridControl.DataSource =
                ((OdemeBilgileriBll)BllTablo).List(x => x.TahakkukId == OwnerForm.Id).ToBindingList<OdemeBilgileriL>();
        }
        ...
        protected override void HareketEkle()
        {
            ...
            var dahaOnceGirilenTaksitSayisi = source.Cast<OdemeBilgileriL>()
                .Count(x => !x.Delete && x.BelgeDurumu != BelgeDurumu.MusteriyeGeriIade);

            if (!ShowEditForms<TopluOdemePlanıEditForm>.ShowDialogEditFrom(source, OwnerForm.Id, bakiyeHesapla(), ((TahakkukEditForm)OwnerForm).txtKayitTarihi.DateTime.Date, dahaOnceGirilenTaksitSayisi)) return;
        ...
        protected override void SutunGizleGoster()
        {
            ...
            colBankaHesapAdi.Visible = entity.OdemeTipi == OdemeTipi.EPos || entity.OdemeTipi == OdemeTipi.Ots ||
                                       entity.OdemeTipi == OdemeTipi.Pos;
            colTakipNo.Visible = entity.OdemeTipi == OdemeTipi.Pos;
            colBlokeGunSayisi.Visible = entity.OdemeTipi == OdemeTipi.EPos || entity.OdemeTipi == OdemeTipi.Ots ||
                                       entity.OdemeTipi == OdemeTipi.Pos;
                ...
                switch (entity.OdemeTipi)
                {
                    ...
                    case OdemeTipi.Pos:
                        if (entity.BankaHesapId == null)
                        {
                            ...
                            tablo.SetColumnError(colBankaHesapAdi, "Banka Hesap Adı Alanına Geçerli Bir Değer Giriniz.");
                        }
                        break;
                }
        ...
        protected override void Tablo_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column == colVade)
            {
                ...
                entity.VadeYazi = ((decimal)e.Value).YaziIleTutar();
        ...
        protected override void Tablo_FocusedColumnChanged(object sender, FocusedColumnChangedEventArgs e)
        {
            ...
            if (e.FocusedColumn == colBankaHesapAdi)
                e.FocusedColumn.Sec(tablo, insUptNavigator.Navigator, repositoryItemButtonBankaHesap, colBankaHesapId);
                ...
                e.FocusedColumn.Sec(tablo, insUptNavigator.Navigator, repositoryItemButtonBankaSube, colBankaSubeId, colBankaId, colBankaAdi);

            else if (e.FocusedColumn == colVade)
            {
                repositoryItemDateVade.MinValue = ((TahakkukEditForm) OwnerForm).txtKayitTarihi.DateTime.Date;
                repositoryItemDateVade.MaxValue = AnaForm.MaksimumTaksitTarihi;
            }
        }
    }
}
