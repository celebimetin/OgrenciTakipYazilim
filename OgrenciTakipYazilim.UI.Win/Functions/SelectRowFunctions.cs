...
namespace OgrenciTakipYazilim.UI.Win.Functions
{
    public class SelectRowFunctions
    {
        ...
        private void AddEvents(GridView tablo)
        {
            ...
            if (_tablo is BandedGridView bandedGrid)
            {
                bandedGrid.Bands["bndSecim"].Visible = true;
                bandedGrid.Bands["bndSecim"].VisibleIndex = 0;
                bandedGrid.Bands["bndSecim"].Columns.Add((BandedGridColumn)_column);
            }
