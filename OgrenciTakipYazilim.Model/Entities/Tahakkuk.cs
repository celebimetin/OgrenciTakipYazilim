...
namespace OgrenciTakipYazilim.Model.Entities
{
    ...
    {
        [Index("IX_Kod", IsUnique = false), ZorunluAlan("Ögrenci No", "txtKod")]
        ...
        public SonrakiDonemKayitDurumu SonrakiDonemKayitDurumu { get; set; } = SonrakiDonemKayitDurumu.KayitYenile;
        [StringLength(250)]
